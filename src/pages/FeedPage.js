...
const FeedPage = () => {
  ...
  const list = catId ? concepts.filter((c) => c.category === catId) : concepts;
  ...
  const openConcept = (concept) => navigate(`/concept/${concept.id}`);
    ...
    <div className="feed-page">
      ...
      <div className="feed-scroll" ref={scrollRef}>
          ...
          >
            ...
            <div className="feed-slide-inner">
              <div className="feed-slide-top">
                <span className="feed-chip">{getCategory(concept.category)?.icon} {getCategory(concept.category)?.name}</span>
              ...
              <div className="feed-slide-body">
                ...
                <button className="feed-open" onClick={() => openConcept(concept)}>
                  Open full concept
        ...
        <section className="feed-slide feed-end">
          <div className="feed-end-inner">
            ...
            <p>{activeCat ? `That was every concept in ${activeCat.name}.` : 'That was the whole library.'} Keep scrolling learning by opening any concept, or jump to a category.</p>
      ...
      <div className="feed-dots" aria-hidden="true">
        {list.map((c, i) => (
          <span
            key={c.id}
            className={`feed-dot ${i === activeIndex ? 'active' : ''}`}
            onClick={() => {
              const el = scrollRef.current;
